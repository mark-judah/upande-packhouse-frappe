...
def run():
	...
	_add_rows(
		so1, "SAWTROSWHT004 WHITE  52CM", [{"line_idx": 0, "box_idx": 0, "variety": "Athena", "boxes": 2}]
	)
	_add_rows(
		so1,
		"SMIRNOVA PF-NELLI CLASSIC SPRAY 72CM",
		[
	...
	_add_rows(
		so3,
		"CH STOCK MIX 42CM MADAM RED 42CM",
		[
	...
	_add_rows(
		so4, "SAWTROSWHT004 WHITE  52CM", [{"line_idx": 0, "box_idx": 0, "variety": "Athena", "boxes": 1}]
	)
	_add_rows(
		so4,
		"SMIRNOVA PF-NELLI CLASSIC SPRAY 72CM",
